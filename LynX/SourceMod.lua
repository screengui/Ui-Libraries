...
function Library:Window(titletext,MainColor)
    ...
    currentvalue = currentvalue or minvalue
    ...
    SliderTitle.Size = UDim2.new(0.48, 0, 1, 0)
    ...
    Frame.Size = UDim2.new(0, ((currentvalue - minvalue)/(maxvalue - minvalue))*97, 0, 7)
    ...
    Number.Position = UDim2.new(0.88,0,0,0)
    Number.Size = UDim2.new(0.11,0,1,0)
    ...
    local function updateSlider(input)
        local relativeX = math.clamp(input.Position.X - TextButton.AbsolutePosition.X, 0, TextButton.AbsoluteSize.X)
        Value = math.floor(minvalue + (relativeX / TextButton.AbsoluteSize.X) * (maxvalue - minvalue))
        Frame.Size = UDim2.new(0, relativeX, 0, 7)
        Number.Text = tostring(Value)
